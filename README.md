...
You should create one R script called runAnalysis.R that does the following.
...
Please find additional information about the variables, data and transformations in the CodeBook.MD file.
